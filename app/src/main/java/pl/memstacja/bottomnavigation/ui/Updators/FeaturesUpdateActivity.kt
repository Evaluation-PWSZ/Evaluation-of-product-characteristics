...
class FeaturesUpdateActivity: AppCompatActivity() {

    private lateinit var name : TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_features2_update)
        ...
        val buttonAdd = findViewById<Button>(R.id.update_feature)
        val buttonRemove = findViewById<Button>(R.id.delete_feature)
    ...
    fun sendRemoveRequest() {
        ...
        Log.d("CONNECT", "Send to degustation: $degustation_id & Features: $id")
        val url = "https://rate.kamilcraft.com/api/degustations/$degustation_id/features/$id"
